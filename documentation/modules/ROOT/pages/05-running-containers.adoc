...
The last step would be test the image running the container. As the images where created exposing different ports and different messages, it should be easy to run two containers at once in the same host.
