...
This article presents the initial knowledge of the kubernetes world, focused from an interesting starting point to any new kubernetes enthusiastic that wish to discover kubernetes from scratch.
...
* xref:01-introduction.adoc#container-technologies[container-technologies]
